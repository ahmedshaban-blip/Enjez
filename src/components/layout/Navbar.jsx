        ...
        <div className="flex items-center gap-4">
          ...
          {user && (
            <div className="flex items-center gap-4">
              ...
              {/* 1. Chatbot Component (Next to Notifications) */}
              <Chatbot />
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <span className="absolute top-0 right-0 min-w-[18px] h-[18px] px-1 rounded-full bg-red-500 border-2 border-white text-white text-[10px] font-bold leading-none flex items-center justify-center animate-pulse shadow-sm">
                      {unreadCount}
                    </span>
                  )}
                </button>
              ...
              <button onClick={handleLogout} className="h-11 px-6 rounded-xl border border-slate-200 text-sm font-bold text-slate-600 flex items-center justify-center hover:bg-red-50 hover:text-red-600 hover:border-red-100 transition-all duration-200">
                Logout
              </button>
            </div>
          )}
