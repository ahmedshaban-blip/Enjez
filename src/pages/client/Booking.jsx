...
export default function RequestBooking() {
  ...
  const createBookingInDb = async (paypalOrderId) => {
    ...
    const referenceID = `BKG-${Math.random()
      .toString(36)
      .substr(2, 6)
      .toUpperCase()}`;
    ...
    try {
      ...
      showModal({
        ...
        message: `Your booking (${service.name}) has been created successfully.`,
        type: "success",
      });
    } catch (error) {
      hideLoading();
              ...
              <div className="pt-4 space-y-4">
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center gap-2 font-bold text-lg">
                    Confirm Booking (No Online Payment)
                ...
                <div className="border border-slate-200 rounded-2xl p-4 bg-slate-50">
                  <p className="text-sm font-semibold text-slate-700 mb-2 text-center">
                    Or pay securely with PayPal to confirm your booking
                  </p>

                  <PayPalButtons
                    style={{ layout: "vertical" }}
                    disabled={
                      !date || !time || !address || !phone || !selectedAgent
                    }
                    ...
                    onApprove={async (data, actions) => {
                      try {
                        ...
                        await createBookingInDb(order.id);
                      } catch (err) {
                        console.error(err);
                        showModal({
                          title: "Error",
                ...
                <p className="text-center text-xs text-slate-400 mt-2">
                  By confirming your booking or completing the payment, you
