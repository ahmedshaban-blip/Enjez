        ...
        <div className="container mx-auto px-4 py-4 ">
          <div className="mx-auto max-w-2xl">
            <div className="text-center mb-10">
              <h1 className="text-4xl font-black tracking-tighter sm:text-5xl">Request a Service Booking</h1>
              <p className="mt-4 text-lg text-text-secondary-light dark:text-text-secondary-dark">Fill out the details below, and we will contact you to confirm your appointment.</p>
            </div>
            ...
            <div className="rounded-xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark shadow-sm">
                <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <label className="flex flex-col">
                      ...
                      <div className="relative flex w-full items-stretch">
                        ...
                        />
                        <div className="text-text-secondary-light dark:text-text-secondary-dark flex border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark items-center justify-center px-3 rounded-r-lg border-l-0">
                  ...
                  <label className="flex flex-col">
                    ...
                    <textarea
                      className="form-textarea flex w-full min-w-0 flex-1 resize-y overflow-hidden rounded-lg text-text-primary-light dark:text-text-primary-dark border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark min-h-32 placeholder:text-text-secondary-light dark:placeholder:text-text-secondary-dark p-3 text-base focus:border-primary dark:focus:border-primary focus:ring-2 focus:ring-primary/20"
                      placeholder="Please provide any details that will help us prepare for your service..."
                      value={notes}
                      onChange={(e) => setNotes(e.target.value)}
                    />
                    <p className="text-sm text-text-secondary-light dark:text-text-secondary-dark mt-2">Example: "We have a large dog, please let us know if we need to secure it."</p>
                  </label>
